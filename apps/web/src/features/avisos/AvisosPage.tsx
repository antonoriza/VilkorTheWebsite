...
import AvisoDetailModal from './components/AvisoDetailModal'
import AvisoAuditModal from './components/AvisoAuditModal'
...
export default function Avisos() {
  ...
  return (
    <div className="space-y-8">
      ...
      <AvisoDetailModal
        aviso={activeAviso}
        onClose={() => setActiveAviso(null)}
        isAdmin={isAdmin}
        user={user}
        apartment={apartment}
        onEdit={handleOpenEdit}
        onDelete={handleDelete}
        onConfirmAsamblea={handleConfirmAsamblea}
