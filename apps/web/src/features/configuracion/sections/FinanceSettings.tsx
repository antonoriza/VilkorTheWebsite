        ...
        return (
          <div className="space-y-10">
            ...
            <div className="grid grid-cols-[3fr_2fr] gap-8 items-start">
              ...
              {/* COL LEFT: Mensualidad + Otros Conceptos */}
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-slate-400 font-medium mt-0.5">Cuota de mantenimiento · Auto-generada cada mes</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                ...
                <section>
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-[9px] text-slate-400 font-medium">Multas, reservaciones, cargos eventuales</p>
                    </div>
                  </div>
              ...
              <div>
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-400 font-medium">Gastos fijos mensuales</p>
                  </div>
                </div>
